...
<title>Axxess Compliance Engine - Manager Dashboard</title>
...
<div id="dash">
  <div class="hdr">
    <h1>AXXESS COMPLIANCE ENGINE</h1>
  ...
  <button class="v2-banner" id="v2banner" onclick="openWhatsNew()">
    ...
    <span class="v2-text">Axxess Compliance Engine - AI-powered finding verification is now built in. <b>Click to learn what's new.</b></span>
...
<div class="wn-overlay" id="wf-overlay">
  <div class="wn-modal">
    ...
    <p class="wn-dim">Axxess Compliance Engine - Updated Manager Workflow</p>
...
<div class="wn-overlay" id="wn-overlay">
  <div class="wn-modal">
    ...
    <h2>AXXESS COMPLIANCE ENGINE - WHAT'S NEW</h2>
    <p class="wn-dim">For All Managers and Security Reviewers</p>

    <h3>What Changed?</h3>
    <p>Axxess Compliance Engine adds <b class="wn-blue">automatic AI-powered finding verification</b>. When a scan is submitted, our AI (Gemma 4) analyses every finding immediately - no manual steps needed. By the time you open the dashboard, the AI has already determined what is a real threat and what is a false positive.</p>
